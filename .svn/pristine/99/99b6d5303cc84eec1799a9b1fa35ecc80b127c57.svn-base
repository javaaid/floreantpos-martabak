...
public class OpenTicketsListDialog extends POSDialog {
	...
	private void initComponents() {
		...
		btnTransferServer.setText("<html><body><center>TRANSFER<br>PELAYAN</center></body></html>");
...
//		DecimalFormat decimalFormat = new DecimalFormat("0.00");
		...
		public Component getTableCellRendererComponent(JTable table, Object value, boolean isSelected, boolean hasFocus, int row, int column) {
			...
			if (value instanceof Date) {
				...
				label.setText(currencySymbol + NumberUtil.formatToCurrency(((Double) value).doubleValue()));
