...

    {
		...
		for (TicketItem ticketItem : ticketItems) {
			...
			if (includeCookingInstructions) {
				rowNum = includeCookingInstructions(ticketItem, tableRows, rowNum);
			}
		}
	}

	private static int includeCookingInstructions(TicketItem ticketItem, Map<String, ITicketItem> tableRows, int rowNum) {
