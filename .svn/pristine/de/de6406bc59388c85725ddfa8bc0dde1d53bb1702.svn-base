...
public class CouponForm extends BeanEditor {
    ...
    protected void updateView() {
        ...
        tfCouponValue.setValue((coupon.getValue()));
    ...
    protected boolean updateModel() {
        ...
        if (name == null || name.trim().equals("")) {
            MessageDialog.showError("Nama tidak boleh dibiarkan kosong");
            return false;
        }
        if (couponType != CouponAndDiscount.FREE_AMOUNT && couponValue <= 0) {
            MessageDialog.showError("Nilai harus lebih besar dari 0");
            return false;
        }
    ...
    public String getDisplayText() {
        ...
        if (coupon.getId() == null) {
            return "Tambahkan Kupon/Diskon Baru";
        }
        return "Edit Kupon/Diskon";
    }
...
// DO NOT EDIT OR ADD ANY CODE HERE!
    ...
    private void $$$setupUI$$$() {
        ...
        label1.setText("Nama Kupon" + ":");
        CellConstraints cc = new CellConstraints();
        contentPane.add(label1, cc.xy(1, 1));
        final JLabel label2 = new JLabel();
        label2.setText("Tgl Kadaluarsa " + ":");
        ...
        chkNeverExpire.setText("Tidak pernah kadaluarsa");
