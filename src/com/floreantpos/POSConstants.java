...
//	public static final String GRATUITY_ADMINISTRATION = Messages.getString("PosMessage.290"); //$NON-NLS-1$
	...
	public static final String PAYMENT_CONFIRMATION = Messages.getString("PosMessage.312"); //$NON-NLS-1$
	public static final String PAYMENT_CONFIRMATION_CONTENT = Messages.getString("PosMessage.313"); //$NON-NLS-1$
    ...
    public static final String TAX_INCLUDED = Messages.getString("PosMessage.314");
    public static final String TAX_NOT_INCLUDED = Messages.getString("PosMessage.315");
    public static final String DINE_IN = Messages.getString("DINE_IN");
    public static final String TAKE_OUT= Messages.getString("TAKE_OUT");
    public static final String PICKUP = Messages.getString("PICKUP");
    public static final String HOME_DELIVERY= Messages.getString("HOME_DELIVERY");
    public static final String DRIVE_THRU= Messages.getString("DRIVE_THRU");
    public static final String CLOSE_ORDER = Messages.getString("CLOSE_ORDER");
}
