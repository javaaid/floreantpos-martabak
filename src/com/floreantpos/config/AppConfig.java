...
public class AppConfig {
    ...
    private static final String  FEATURE_MKN_DITEMPAT_FLAG = "feature_makan_ditempat_flag";
    private static final String  FEATURE_CLOCK_OUT_FLAG = "feature_clock_out_flag";
    ...
    public static String getFeatureMknDitempatFlag() {
        return config.getString(FEATURE_MKN_DITEMPAT_FLAG, "false");
    }
    public static String getFeatureClockOutFlag() {
        return config.getString(FEATURE_CLOCK_OUT_FLAG, "false");
    }
    ...
    public static void setFeatureMknDitempatFlag(String flag) {
        config.setProperty(FEATURE_MKN_DITEMPAT_FLAG,flag);
    }

    public static void setFeatureClockOutFlag(String flag) {
        config.setProperty(FEATURE_CLOCK_OUT_FLAG,flag);
    }
