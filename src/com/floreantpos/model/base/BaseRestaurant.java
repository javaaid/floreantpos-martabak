...
public abstract class BaseRestaurant  implements Comparable, Serializable {
    ...
    protected java.lang.Boolean armLinuxEnv = true;
    ...
    public java.lang.Boolean isArmLinuxEnv () {
        return armLinuxEnv;
    }
    ...
    public void setArmLinuxEnv(java.lang.Boolean yes) {
        this.armLinuxEnv= yes;
    }
